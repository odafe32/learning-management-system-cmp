...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <!-- file upload -->
    <link rel="stylesheet" href="{{ url('assets/css/file-upload.css?v=' .env('CACHE_VERSION')) }}">
    <!-- file upload -->
    <link rel="stylesheet" href="{{ url('assets/css/plyr.css?v=' .env('CACHE_VERSION')) }}">
    <!-- DataTables -->
    <link rel="stylesheet" href="{{ url('./../cdn.datatables.net/2.0.8/css/dataTables.dataTables.min.css?v=' .env('CACHE_VERSION')) }}.">
    <!-- full calendar -->
    <link rel="stylesheet" href="{{ url('assets/css/full-calendar.css?v=' .env('CACHE_VERSION')) }}">
    <!-- jquery Ui -->
    <link rel="stylesheet" href="{{ url('assets/css/jquery-ui.css?v=' .env('CACHE_VERSION')) }}">
    <!-- editor quill Ui -->
    <link rel="stylesheet" href="{{ url('assets/css/editor-quill.css?v=' .env('CACHE_VERSION')) }}">
    <!-- apex charts Css -->
    <link rel="stylesheet" href="{{ url('assets/css/apexcharts.css?v=' .env('CACHE_VERSION')) }}">
    <!-- calendar Css -->
    <link rel="stylesheet" href="{{ url('assets/css/calendar.css?v=' .env('CACHE_VERSION')) }}">
    <!-- jvector map Css -->
    <link rel="stylesheet" href="{{ url('assets/css/jquery-jvectormap-2.0.5.css?v=' .env('CACHE_VERSION')) }}">
    <!-- Main css -->
