                                ...
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <div class="d-flex align-items-center justify-content-center gap-2">
                                            ...
                                            @if(in_array($submission->status, ['submitted', 'pending']))
                                                <!-- Grade Button -->
                                                <button type="button" 
            ...
            <div class="modal-body p-0">
                <div class="row g-0">
                    ...
                    <div class="col-md-8 p-24">
                        ...
                        <div class="mb-20">
                            <h6 class="text-md fw-semibold mb-8">Submitted Code</h6>
                    ...
                    <div class="col-md-4 bg-gray-50 p-24">
                        ...
                        <!-- Quick Actions -->
                        <div class="mb-20">
                            <h6 class="text-md fw-semibold mb-12">Actions</h6>
                            <div class="d-grid gap-2">
                                <button type="button" class="btn btn-outline-success btn-sm" id="gradeFromModal">
                                    <i class="ph ph-check-circle me-2"></i>
                                    Grade This Submission
                                </button>
                                <button type="button" class="btn btn-outline-info btn-sm" onclick="downloadSubmission()">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    viewButtons.forEach(button => {
        button.addEventListener('click', function(e) {
            ...
            document.getElementById('modalCodeContent').querySelector('code').textContent = codeContent || 'No code submitted';
...
function downloadSubmission() {
    ...
    a.href = url;
    a.download = `${studentName}_${assignmentTitle.replace(/[^a-z0-9]/gi, '_')}.txt`;
