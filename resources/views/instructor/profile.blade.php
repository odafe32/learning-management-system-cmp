        ...
        <div class="row gy-4">
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('instructor.profile.update') }}" method="POST" enctype="multipart/form-data" id="profileForm">
                            @csrf
                            @method('PUT')
    ...
    <i class="ph ph-camera"></i>
            ...
            <div class="col-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('instructor.profile.password') }}" method="POST" id="passwordForm">
                            @csrf
                            @method('PUT')
