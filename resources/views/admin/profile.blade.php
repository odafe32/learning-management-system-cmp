    ...
    <i class="ph ph-camera"></i>
                                ...
                                <div class="col-12">
                                    <div class="alert alert-info-50 border border-info-200 radius-8 p-16">
                                        <div class="flex-align gap-8">
                                            <i class="ph ph-shield-check text-info-600"></i>
                                            <div>
                                                <h6 class="text-sm fw-semibold text-info-600 mb-4">Administrator Account</h6>
                                                <p class="text-xs text-info-600 mb-0">
                                                    You have full administrative privileges. Please ensure your contact information is up to date for security purposes.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="flex-align justify-content-end gap-8">
                                        <button type="reset" class="btn btn-gray radius-8">Reset</button>
                    ...
                    <div class="card-body">
                        <form action="{{ route('admin.profile.password') }}" method="POST" id="passwordForm">
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-12">
                                    <div class="alert alert-warning-50 border border-warning-200 radius-8 p-16">
                                        <div class="flex-align gap-8">
                                            <i class="ph ph-warning text-warning-600"></i>
                                            <div>
                                                <h6 class="text-sm fw-semibold text-warning-600 mb-4">Security Notice</h6>
                                                <p class="text-xs text-warning-600 mb-0">
                                                    As an administrator, use a strong, unique password. Consider enabling two-factor authentication for enhanced security.
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-12">
                                    <div class="flex-align justify-content-end gap-8">
                                        <button type="reset" class="btn btn-warning radius-8">Reset</button>
                                        <button type="submit" class="btn btn-primary radius-8">
                        ...
                        <div class="row gy-4">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center gap-12">
                                    ...
                                    <div>
                                        <h6 class="text-sm fw-semibold mb-4">Last Login</h6>
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center gap-12">
                                    ...
                                    <div>
                                        <h6 class="text-sm fw-semibold mb-4">Account Created</h6>
                                        <p class="text-xs text-gray-600 mb-0">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center gap-12">
                                    <div class="w-40 h-40 {{ $user->email_verified_at ? 'bg-success-50 text-success-600' : 'bg-warning-50 text-warning-600' }} rounded-circle flex-center">
                                        <i class="ph {{ $user->email_verified_at ? 'ph-check-circle' : 'ph-warning-circle' }}"></i>
                                    </div>
                                    <div>
                                        <h6 class="text-sm fw-semibold mb-4">Email Verification</h6>
                                        <p class="text-xs {{ $user->email_verified_at ? 'text-success-600' : 'text-warning-600' }} mb-0">
                            ...
                            <div class="col-md-6">
                                <div class="d-flex align-items-center gap-12">
                                    <div class="w-40 h-40 bg-danger-50 text-danger-600 rounded-circle flex-center">
                                        <i class="ph ph-shield-check"></i>
                                    </div>
                                    <div>
                                        <h6 class="text-sm fw-semibold mb-4">Account Role</h6>
